...
export default function Portfolio() {
  ...
  const opacitySection2 = useTransform(scrollYProgress, [0.1, 0.2, 0.3], [0, 1, 1])
  const opacitySection3 = useTransform(scrollYProgress, [0.3, 0.4, 0.5], [0, 1, 1])
  const opacitySection4 = useTransform(scrollYProgress, [0.5, 0.6, 0.7], [0, 1, 1])
  const opacitySection5 = useTransform(scrollYProgress, [0.7, 0.8, 0.9], [0, 1, 1])
  ...
  return (
    <div ref={containerRef} className="bg-black text-white min-h-screen">
        ...
        <div className="container relative z-10 px-4 mx-auto">
          ...
          >
            <div className="relative w-40 h-40 mx-auto mb-8 rounded-full overflow-hidden border-4 border-purple-500">
              <Image src="./ADHIL.jpg" alt="Developer Avatar" fill className="object-cover" />
            </div>
      ...
      {/* About Section */}
      <motion.section style={{ opacity: opacitySection2 }} className="py-20 bg-gradient-to-b from-black to-gray-900">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            >
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                ...
                foundation in MongoDB, Express.js, React, and Node.js, I create seamless user experiences backed by
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                ...
                from e-commerce platforms to real-time applications. I'm constantly exploring new technologies and
      ...
      <footer className="py-8 bg-black border-t border-gray-800">
        <div className="container px-4 mx-auto text-center">
          ...
          <div className="flex justify-center space-x-4 mt-4">
            ...
            <Link href="mailto:contact@example.com" className="text-gray-400 hover:text-purple-500 transition-colors">
